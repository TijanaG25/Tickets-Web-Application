...
<section class="container py-5">
    <div class="text-center mb-5">
        <h1 class="text-warning fw-bold">O Prime Tickets</h1>
        <p class="lead text-light">Vaša sigurna karta do najboljih događaja.</p>
    </div>
    <div class="row g-4">
        <div class="col-md-6">
            <div class="about-card p-4 h-100">
                <h4><i class="bi bi-star-fill text-warning"></i> Naša misija</h4>
                <p>
                    Prime Tickets je moderna platforma za online kupovinu karata za koncerte,
                    pozorišne predstave, sportske događaje, festivale i muzeje.
                    Naš cilj je da korisnicima omogućimo brzo, sigurno i jednostavno
                    rezervisanje mesta.
                </p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="about-card p-4 h-100">
                <h4><i class="bi bi-shield-lock-fill text-warning"></i> Sigurnost</h4>
                <p>
                    Svi podaci su zaštićeni savremenim sigurnosnim protokolima.
                    Kupovina je jednostavna, a vaše informacije ostaju bezbedne.
                </p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="about-card p-4 h-100">
                <h4><i class="bi bi-lightning-fill text-warning"></i> Brzina</h4>
                <p>
                    Samo nekoliko klikova vas deli od vaše karte.
                    Naša platforma omogućava trenutnu rezervaciju mesta.
                </p>
            </div>
        </div>
        <div class="col-md-6">
            <div class="about-card p-4 h-100">
                <h4><i class="bi bi-people-fill text-warning"></i> Zajednica</h4>
                <p>
                    Povezujemo ljude sa događajima koji inspirišu.
                    Verujemo da kultura i zabava treba da budu dostupni svima.
                </p>
            </div>
        </div>
    </div>
